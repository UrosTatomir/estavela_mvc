    ...
    <div class="container-fluid">
        <div class="container mt-5 p-5">
            <div class="container mt-5 col-6 text-center">
                <h4 class="text-success">Send new Newsletter</h4>
                ...
                <form action="routes.php" method="post">
                    ...
                    <br>
                    <textarea  cols="70" rows="10" name="Comments" id="Comments"></textarea>
                    <br>
                    <input type="submit" name=page value="Send newsletter">
                </form>
            </div>
        </div>
